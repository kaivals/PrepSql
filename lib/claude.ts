...
const modeGuidelines: Record<QueryMode, string> = {
  ...
  analytics:
    "Generate analytical queries with aggregations, window functions, CTEs, and JOINs as appropriate.",
  schema:
    "Generate DDL queries to modify tables (ALTER TABLE, CREATE TABLE, etc.) if requested, otherwise focus on schema analysis.",
};
