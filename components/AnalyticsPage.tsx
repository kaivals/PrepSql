  ...
  return (
    <div className="flex flex-1 flex-col overflow-y-auto bg-slate-50/50 p-6 lg:p-8">
      ...
      <div className="mb-8 grid gap-6 md:grid-cols-3">
        {/* Health Dial */}
        <div className="rounded-xl border border-border bg-card flex flex-col items-center justify-center p-6 shadow-sm">
      ...
      {selectedRun && (
        <div className="mt-8 rounded-xl border border-border bg-card space-y-6 p-6 shadow-sm">
