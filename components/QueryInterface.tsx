    ...
    <div className="flex flex-1 flex-col overflow-hidden">
      ...
      <div className="bg-transparent pb-6 pt-2 px-4 shrink-0 w-full">
        ...
        <form
          ...
          className="mx-auto flex max-w-2xl items-end gap-2 bg-card/65 backdrop-blur-md border-2 border-slate-300 dark:border-slate-700 pl-4 pr-2 py-2 rounded-[26px] shadow-[0_4px_30px_rgba(59,130,246,0.12)] focus-within:shadow-[0_10px_35px_rgba(59,130,246,0.22)] focus-within:border-primary transition-all focus-within:ring-2 focus-within:ring-primary/10"
        >
