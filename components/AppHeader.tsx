...
import { Database, LogOut, BarChart3, Settings, Menu } from 'lucide-react';
    ...
    <header className="relative border-b border-border bg-card">
      <div className="flex h-14 items-center justify-between px-4 md:px-6">
        ...
        {showModeSwitcher && onModeChange && (
          <div className="absolute left-1/2 top-14 flex w-full -translate-x-1/2 items-center justify-center border-b border-border bg-card p-1.5 md:static md:w-auto md:translate-x-0 md:border-none md:bg-muted/40 md:p-0.5 md:rounded-lg">
            {modes.map((m) => (
              <button
                key={m.id}
                type="button"
